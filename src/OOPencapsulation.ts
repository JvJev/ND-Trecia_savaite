...
console.group('1. Naudojant "getter" ir "setter" NESUTRUMPINTAS funkcijas:');
{
  ...
  `);
  {
    class Person {
       ...
       // constructor( private name: string, private surname: string, private items: Array<{title: string, price: number}>, private age: number)
        constructor( 
            name: string, 
            surname: string, 
        ...
        setItems(value: Array<{title: string, price: number}>){
            this.items = value;
        };
