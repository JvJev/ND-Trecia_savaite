...
console.group('1. Sukurkite funkciją "joinArrays", kuri apjungia 2 masyvus. Grąžinamo masyvo tipas turi būti lygus parametrais perduotų masyvų tipų sajungai');
{
    ...
    const visiGyvunai = <T, K>(arr1: T[], arr2: K[]): (T | K)[] => [...arr1, ...arr2];
...
// type filtruotiFunkcijas<T, (element: extends K)> => Boolean;
// const uzdetiFiltrus = <T>(arr:T[],
//     filterFunc: filtruotiFunkcijas<T>[]): T[] =>
